...
--
-- insert into pagamento (pedido_id, status, tipo_pagamento) values (1, 'RECEBIDO', 'cartao');
-- insert into pagamento (pedido_id, status, tipo_pagamento) values (2, 'PROCESSANDO', 'cartao');
-- insert into pagamento (pedido_id, status, tipo_pagamento) values (3, 'RECEBIDO', 'boleto');
-- insert into pagamento (pedido_id, status, tipo_pagamento) values (4, 'PROCESSANDO', 'cartao');
--
